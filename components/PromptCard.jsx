...
const PromptCard = ({ post, handleTagClick, handleEdit, handleDelete }) => {
    ...
    return (
        <div className="prompt_card">
            <div className="flex justify-between items-start gap-5">
                <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer" onClick={handleProfileClick}>
                    ...
                    <div className="flex flex-col">
                        <h3 className="font-satoshi font-semibold text-gray-600">{post.creator.username}</h3>
            ...
            <p className="my-4 font-satosho text-sm text-gray-700">{post.prompt}</p>
            ...
            {session?.user.id === post.creator._id && pathName === '/profile' && (
                <div className="mr-5 flex-end gap-4 border-t border-gary-100 pt-3">
